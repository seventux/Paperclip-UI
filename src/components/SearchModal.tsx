      ...
      {isOpen && (
        ...
        >
          <motion.div
            ...
            className="w-[min(560px,calc(100vw-2rem))] max-h-[min(480px,80vh)] overflow-hidden rounded-2xl backdrop-blur-2xl bg-(--modal-bg) border border-white/10 shadow-2xl"
          >
            {/* Search input */}
